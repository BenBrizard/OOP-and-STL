...
Produit::Produit(Fournisseur& fournisseur,const string& nom, int reference, double prix,TypeProduit type) : nom_(nom), reference_(reference),
prix_(prix), fournisseur_(fournisseur), type_(type)
{
